...
router.put('/vendor/:id/confirm', authenticateUser, authorizeRoles('vendor'), confirmVendorOrder);
router.put('/vendor/:id/delivery', authenticateUser, authorizeRoles('vendor'), updateDeliveryStatus);
