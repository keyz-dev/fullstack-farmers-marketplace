...
const ProfileStats = ({ stats }) => {
  ...
  const getActivityLevel = (lastLogin) => {
    ...
    if (diffInDays <= 1)
      return { level: "Very Active", color: "green", icon: "🟢" };
    ...
    <div className="p-3 md:p-6 space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg border border-green-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="flex items-center gap-3 p-3 bg-white rounded-sm border border-green-100">
          ...
          <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-500">
                You placed an order for hair products
              </p>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center gap-3">
              <div
                className={`w-4 h-4 rounded-full bg-${activityLevel.color}-500`}
              ></div>
              <div>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center gap-3">
              <div
                className={`w-4 h-4 rounded-full bg-${
                  stats?.profileComplete ? "green" : "orange"
                }-500`}
              ></div>
              <div>
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-gray-700">
              Complete your profile to unlock additional features and
          ...
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
            <p className="text-sm text-gray-700">
              Verify your email address to receive important updates and order
              confirmations.
            </p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
            <p className="text-sm text-gray-700">
              Leave reviews for products you've purchased to help other
              customers.
            </p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
            <p className="text-sm text-gray-700">
              Check your order history regularly to track your purchases and
              delivery status.
            </p>
          </div>
        </div>
