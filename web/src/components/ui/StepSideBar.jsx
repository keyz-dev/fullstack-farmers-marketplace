...
import BraidSterCard from "../../assets/images/braidster_card.jpg";
...
const StepSideBar = ({ currentStep, visitedSteps, steps, homePath = "/" }) => {
  ...
  return (
    <>
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex w-[360px] flex-shrink-0 h-screen bg-light_bg border-r border-r-line_clr px-8 py-4 flex-col justify-between">
