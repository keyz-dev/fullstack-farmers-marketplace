  ...
  return (
    <div className="min-h-fit flex items-center justify-center">
      ...
      >
        ...
        {errors.submit && (
          <div className="rounded-xs bg-error-bg-light dark:bg-error-bg-dark p-4 my-4">
            <p className="text-sm text-error dark:text-error-text-dark text-center">
              {errors.submit}
            </p>
          </div>
        )}
        ...
        <div className="flex items-center my-4">
          <div className="flex-grow border-t border-gray-200 dark:border-secondary"></div>
